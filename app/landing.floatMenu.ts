...
export class FloatMenu extends TimelineController {
    ...
    public features: [ProductModel] = [
        new ProductModel(
            ...
            "QU'EST CE QUE LE CAFÉ ARTISANAL?",
            "",
            "http://www.kitchenaid.ca/fr_CA/2_1_2_3_22847/brand_small-appliances_coffee-products_test-what-is-craft-coffee.content.html?skipCache=true",
            "",
        ...
        new ProductModel(
            ...
            "INFUSEURS DE CAFÉ ARTISANAL KITCHENAID®",
            "",
            "http://www.kitchenaid.ca/fr_CA/2_1_2_3_3449/brand_small-appliances_coffee-products_product-information.content.html?skipCache=true",
            "",
            "@language-Craft Coffee Landing Page",
            "@language-Clicked Learn More CTA's",
            "KA-Craft Brewers"
