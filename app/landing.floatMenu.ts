...
export class FloatMenu extends TimelineController {
    ...
    public features:[ProductModel] = [
        ...
        new ProductModel("./public/images/rl-coffee-what-button.png","QU'EST CE QUE LE CAFÉ ARTISANAL?","","http://www.kitchenaid.ca/fr_CA/2_1_2_3_22847/brand_small-appliances_coffee-products_test-what-is-craft-coffee.content.html?skipCache=true",""),
