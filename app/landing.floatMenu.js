        ...
        execute: function() {
            FloatMenu = (function (_super) {
                ...
                function FloatMenu(elementRef) {
                    _super.call(this);
                    this.features = [
                        new products_model_1.ProductModel("./public/images/rl-coffee-what-button.png", "What is craft coffee?", "", "http://kitchenaid.ca", ""),
                        new products_model_1.ProductModel("./public/images/rl-coffee-brewer-button.png", "KITCHENAID® CRAFT BREWERS", "", "http://kitchenaid.ca", "")
                    ];
