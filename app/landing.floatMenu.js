        ...
        execute: function() {
            FloatMenu = (function (_super) {
                ...
                function FloatMenu(elementRef) {
                    _super.call(this);
                    this.features = [
                        new products_model_1.ProductModel("./public/images/rl-coffee-what-button.png", "What is craft coffee?", "", "http://www.kitchenaid.ca/en_CA/2_1_2_3_22847/brand_small-appliances_coffee-products_test-what-is-craft-coffee.content.html?skipCache=true", "", "@language-Craft Coffee Landing Page", "@language-Clicked Learn More CTA's", "What is Craft Coffee"),
                        new products_model_1.ProductModel("./public/images/rl-coffee-brewer-button.png", "KITCHENAID® CRAFT BREWERS", "", "http://www.kitchenaid.ca/en_CA/2_1_2_3_3449/brand_small-appliances_coffee-products_product-information.content.html?skipCache=true", "", "@language-Craft Coffee Landing Page", "@language-Clicked Learn More CTA's", "KA-Craft Brewers")
                    ];
