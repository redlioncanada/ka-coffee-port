        ...
        execute: function() {
            FloatMenu = (function (_super) {
                ...
                function FloatMenu(elementRef) {
                    _super.call(this);
                    this.features = [
                        new products_model_1.ProductModel("/images/ka-coffee-port/rl-coffee-what-button.png", "QU'EST CE QUE LE CAFÉ ARTISANAL?", "", "http://kitchenaid.ca", ""),
                        new products_model_1.ProductModel("/images/ka-coffee-port/rl-coffee-brewer-button.png", "INFUSEURS DE CAFÉ ARTISANAL KITCHENAID®", "", "http://cuat.kitchenaid.ca/fr_CA/2_1_2_3_3449/brand_small-appliances_coffee-products_product-information.content.html?skipCache=true", "")
                    ];
