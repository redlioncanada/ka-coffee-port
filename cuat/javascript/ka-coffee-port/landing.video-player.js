            ...
            VideoPlayer = (function () {
                function VideoPlayer(logger) {
                    ...
                    this.videos = [
                        {
                            id: '9IFIdkLo29Y',
                            thumb: '/images/ka-coffee-port/video-select-1.jpg',
                        ...
                        {
                            id: 'fWbEHxpUEwM',
                            thumb: '/images/ka-coffee-port/video-select-2.jpg',
                        ...
                        {
                            id: 'RxnPMBOUWfk',
                            thumb: '/images/ka-coffee-port/video-select-3.jpg',
                ...
                VideoPlayer = __decorate([
                    core_1.Component({
                        ...
                        templateUrl: '/javascript/ka-coffee-port/views/landing.video-player.view.html',
