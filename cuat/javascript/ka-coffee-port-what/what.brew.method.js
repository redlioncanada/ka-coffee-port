        ...
        execute: function() {
            BrewMethod = (function (_super) {
                ...
                function BrewMethod(elementRef) {
                    _super.call(this);
                    this.images = [
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/whatiscraftcoffee/what-water-temp.jpg", "WATER TEMPERATURE", "The correct water temperature allows the grinds to awaken and reveal their flavour.", " ", " "),
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/whatiscraftcoffee/what-brew-time.jpg", "OPTIMAL BREW TIME", "The proper brew time is essential to ensuring the roast, grind, and temperature extract properly.", " ", " "),
                    ];
                ...
                BrewMethod = __decorate([
                    core_1.Component({
                        ...
                        templateUrl: '/javascript/ka-coffee-port-what/views/what.brew.method.view.html',
