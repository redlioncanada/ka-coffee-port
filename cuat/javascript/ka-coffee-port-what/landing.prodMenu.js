        ...
        execute: function() {
            ProductMenu = (function (_super) {
                ...
                function ProductMenu(elementRef) {
                    _super.call(this);
                    this.products = [
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/rl-coffee-btn-burr.jpg", "Burr Grinder »", "", "http://kitchenaid.ca", ""),
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/rl-coffee-siphon.jpg", "Siphon Coffee Brewer »", "", "http://kitchenaid.ca", ""),
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/rl-coffee-btn-espresso.jpg", "Espresso »", "", "http://kitchenaid.ca", ""),
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/rl-coffee-btn-french.jpg", "Precision Press »", "", "http://kitchenaid.ca", ""),
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/rl-coffee-btn-PO.jpg", "Custom Pour Over Coffee Brewer »", "", "http://kitchenaid.ca", "")
                    ];
