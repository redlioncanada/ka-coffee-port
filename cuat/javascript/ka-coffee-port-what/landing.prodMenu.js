        ...
        execute: function() {
            ProductMenu = (function (_super) {
                ...
                function ProductMenu(elementRef) {
                    _super.call(this);
                    this.products = [
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/rl-coffee-btn-burr.jpg", "Burr Grinder »", "", "http://www.kitchenaid.ca/en_CA/2_1_2_3_3442/brand_small-appliances_coffee-products_burr-grinder.content.html?skipCache=true", "", "@language-What is Craft Coffee Landing Page", "@language-Clicked Main Craft Coffee Collection", "Burr Grinder"),
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/rl-coffee-siphon.jpg", "Siphon Coffee Brewer »", "", "http://www.kitchenaid.ca/en_CA/2_1_2_3_3450/brand_small-appliances_coffee-products_siphonbrew.content.html?skipCache=true", "", "@language-What is Craft Coffee Landing Page", "@language-Clicked Main Craft Coffee Collection", "Siphon Coffee Brewer"),
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/rl-coffee-btn-espresso.jpg", "Espresso »", "", "http://www.kitchenaid.ca/en_CA/2_1_2_3_3445/brand_small-appliances_coffee-products_espresso-coffee.content.html", "", "@language-What is Craft Coffee Landing Page", "@language-Clicked Main Craft Coffee Collection", "Espresso"),
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/rl-coffee-btn-french.jpg", "Precision Press »", "", "http://www.kitchenaid.ca/en_CA/2_1_2_3_3448/brand_small-appliances_coffee-products_precision-press.content.html", "", "@language-What is Craft Coffee Landing Page", "@language-Clicked Main Craft Coffee Collection", "Precision Press"),
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/rl-coffee-btn-PO.jpg", "Custom Pour Over Coffee Brewer »", "", "http://www.kitchenaid.ca/en_CA/2_1_2_3_3447/brand_small-appliances_coffee-products_pour-over-coffee.content.html?skipCache=true", "", "@language-What is Craft Coffee Landing Page", "@language-Clicked Main Craft Coffee Collection", "Pour Over Brewer")
                    ];
                ...
                ProductMenu = __decorate([
                    core_1.Component({
                        selector: 'products',
                        templateUrl: '/javascript/ka-coffee-port-what/views/product.view.html',
