        ...
        execute: function() {
            FloatMenu = (function (_super) {
                ...
                function FloatMenu(elementRef) {
                    _super.call(this);
                    this.features = [
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/rl-coffee-what-button.png", "What is craft coffee?", "", "http://kitchenaid.ca", ""),
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/rl-coffee-brewer-button.png", "KITCHENAID® CRAFT BREWERS", "", "http://kitchenaid.ca", "")
                    ];
                ...
                FloatMenu = __decorate([
                    core_1.Component({
                        selector: 'float-menu',
                        templateUrl: '/javascript/ka-coffee-port-what/views/masthead.floatNav.view.html',
