        ...
        execute: function() {
            WhatIntro = (function (_super) {
                ...
                function WhatIntro(elementRef) {
                    _super.call(this);
                    this.images = [
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/whatiscraftcoffee/what-topBeans.jpg", " ", " ", "https://www.youtube.com/watch?v=gXm2NRiC0oY", " "),
                        new products_model_1.ProductModel("/images/ka-coffee-port-what/whatiscraftcoffee/what-topBackTexture.jpg", " ", " ", "https://www.youtube.com/watch?v=gXm2NRiC0oY", " "),
                    ];
