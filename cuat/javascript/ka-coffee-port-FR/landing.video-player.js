System.register(['angular2/core', './landing.video-player.selector.js', './landing.video-player.player.js', './services/logger.service.js'], function(exports_1, context_1) {
    "use strict";
            ...
            VideoPlayer = (function () {
                function VideoPlayer(logger) {
                    ...
                    this.videos = [
                        {
                            id: '9IFIdkLo29Y',
                            thumb: '/images/ka-coffee-port-FR/video-select-1.jpg',
                        ...
                        {
                            id: 'fWbEHxpUEwM',
                            thumb: '/images/ka-coffee-port-FR/video-select-2.jpg',
                        ...
                        {
                            id: 'RxnPMBOUWfk',
                            thumb: '/images/ka-coffee-port-FR/video-select-3.jpg',
                ...
                VideoPlayer = __decorate([
                    core_1.Component({
                        ...
                        templateUrl: '/javascript/ka-coffee-port-FR/views/landing.video-player.view.html',
