System.register(['angular2/core', './landing.timeline-controller.js', './landing.floatButton.js', './models/products.model.js', './landing.videoPlayer-side.js'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            WhatIntro = (function (_super) {
                ...
                function WhatIntro(elementRef) {
                    _super.call(this);
                    this.images = [
                        new products_model_1.ProductModel("/images/ka-coffee-port-what-fr/whatiscraftcoffee/what-topBeans.jpg", " ", " ", "https://www.youtube.com/watch?v=gXm2NRiC0oY", " "),
                        new products_model_1.ProductModel("/images/ka-coffee-port-what-fr/whatiscraftcoffee/what-topBackTexture.jpg", " ", " ", "https://www.youtube.com/watch?v=gXm2NRiC0oY", " "),
                    ];
                ...
                WhatIntro = __decorate([
                    core_1.Component({
                        selector: 'intro',
                        templateUrl: '/javascript/ka-coffee-port-what-fr/views/what.intro.view.html',
