System.register(['angular2/core', 'angular2/platform/browser', './services/analytics.service.js'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            AnalyticsOn = (function () {
                ...
                AnalyticsOn = __decorate([
                    ...
                    __metadata('design:paramtypes', [core_1.ElementRef, analytics_service_1.Analytics])
                ], AnalyticsOn);
                return AnalyticsOn;
            }());
